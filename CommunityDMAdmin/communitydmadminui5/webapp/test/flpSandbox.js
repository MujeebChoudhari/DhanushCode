		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#nscommunitydmadminui5communitydmadminui5-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"nscommunitydmadminui5communitydmadminui5-display": {
								"semanticObject": "nscommunitydmadminui5communitydmadminui5",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=nscommunitydmadminui5.communitydmadminui5",
									"url": sap.ui.require.toUrl("nscommunitydmadminui5/communitydmadminui5")
								}
							}
						}
					}
